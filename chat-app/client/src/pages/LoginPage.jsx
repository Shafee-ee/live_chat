...
const LoginPage = () => {
    ...
    return (
        ...
        flex items-center justofy-center gap-8 
        sm:justify-evenly max-sm:flex-col backdrop-blur-2xl '>
            ...
            text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
                ...
                {currentState === "Sign-up" && !isDataSubmitted && (<input
                ...
                <button type='submit' className='py-3 bg-gradient-to-r from-purple-400 to-violet-600 text-white rounded-md cursor-pointer'>{currentState === "Sign-up" ? "Create Account" : "Login"}</button>
                ...
                <div className='flex flex-col gap-2'>
                    {currentState === "Sign-up" ? (
                        <p className='text-sm text-gray-600'>Already have an account? <span
                            ...
                            className='font-medium text-violet-400 cursor-pointer'>Login here</span></p>
                    ) : (
                        <p className='text-sm text-gray-600'>Create an Account <span
                            onClick={() => { setCurrentState("Sign-up"); setIsDataSubmitted(false) }}

                            className='font-medium text-violet-400 cursor-pointer'>Click here</span></p>
                    )}
                </div>
            </form>
